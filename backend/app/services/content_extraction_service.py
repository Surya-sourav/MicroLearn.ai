...
class ContentExtractionService:
    ...
    async def extract_images(self, pdf_path: str, output_dir: str) -> List[Dict[str, Any]]:
        ...
        Returns list of images with their metadata, captions, and analysis
        """
        try:
            images = []
            ...
            for page_num, page in enumerate(pages, start=1):
                ...
                for idx, contour in enumerate(contours):
                    if cv2.contourArea(contour) > 1000:  # Filter small contours
                        ...
                        confidence = outputs.logits.softmax(-1)[0][predicted_class].item()
                        ...
                        images.append({
                            ...
                            'classification': {
                                'label': self.image_model.config.id2label[predicted_class],
